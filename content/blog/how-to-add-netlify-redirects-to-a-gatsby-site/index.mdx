...
export { default as banner } from './0__NUMywiwxz5KPJBcr.jpg';
export const bannerCaption =
  'Photo by <a href="https://unsplash.com/@bdchu614" target="_blank" rel="noopener noreferrer">Brendan Church</a> on Unsplash';
