...
While it is possible to import CJS modules in ESM (using `import * as CJSModule from 'cjs-module'`), the other way around doesn’t work. Hence, a lot of tools that worked with your code required you to still use CommonJS.
